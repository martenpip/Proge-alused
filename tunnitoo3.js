//Array CRUDE (list, massiiv, array) 
//Create [] 
["test", 2, 3, null] 
console.log([])
let list = []
...
list.filter(elm => elm => 0) // 2,3

let fruits = ["orange", "pear", "pineapple"]; fruits.indexOf("pear")
1
fruits.push("pear")
4
fruits.push("pear")
...
li.append(offers[0][0])
document.body.append(li)

offers=[["Crossroad Gardens","88"],["Strawberry Mountein Lands","57"]]